  ...
  return (
    <div className="text-center">
      <footer>
        ...
        <p className="footer-contact">e. <a className="footer-email" href="mailto:crodtennis@gmail.com">itrainuwin@gmail.com</a></p>
        <div className="container">
            <div className="row">
                <div className="col-12 text-center pb-5 mt-3 footer-social-media">
                    ...
                    <a target="_blank" href="https://www.yelp.com/biz/itrainuwin-tennis-woodland-hills"><i class="fab ml-5 fa-yelp"></i></a> 
                </div>
            </div>
        </div>
      </footer>
